...
--
-- Name: actuator_data; Type: TABLE; Schema: public; Owner: iot_hidroponik
--
...
ALTER TABLE IF EXISTS public.actuator_data OWNER TO iot_hidroponik;

--
-- Name: sensor_data; Type: TABLE; Schema: public; Owner: iot_hidroponik
--
...
ALTER TABLE IF EXISTS public.sensor_data OWNER TO iot_hidroponik;

SELECT public.create_hypertable('public.sensor_data', 'timestamp', if_not_exists => TRUE);

SELECT public.create_hypertable('public.actuator_data', 'timestamp', if_not_exists => TRUE);
...
SELECT public.add_compression_policy('public.sensor_data', INTERVAL '1 month', if_not_exists => TRUE);

SELECT public.add_compression_policy('public.actuator_data', INTERVAL '1 month', if_not_exists => TRUE);
